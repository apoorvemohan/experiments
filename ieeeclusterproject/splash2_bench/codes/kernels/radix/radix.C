...
//   key[0] = (long long *) G_MALLOC(num_keys*sizeof(long long));
//   key[1] = (long long *) G_MALLOC(num_keys*sizeof(long long));
 //  key_partition = (long long *) G_MALLOC((number_of_processors+1)*sizeof(long long));
  // rank_partition = (long long *) G_MALLOC((number_of_processors+1)*sizeof(long long));
...
//   rank_me = (long long **) G_MALLOC(size);
posix_memalign(&rank_me ,sizeof(long long **) ,(size));
   ...
   for (i=0;i<number_of_processors;i++) {
//     gp[i].rank_ff = (long long *) G_MALLOC(radix*sizeof(long long)+PAGE_SIZE);
...
//   key_density = (long long *) G_MALLOC(radix*sizeof(long long));
